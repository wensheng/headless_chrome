...
from headless_chrome.common.by import By
from headless_chrome.common.options import BaseOptions
from headless_chrome.common.print_page_options import PrintOptions
from headless_chrome.common.timeouts import Timeouts
from headless_chrome.common.virtual_authenticator import Credential
from headless_chrome.common.virtual_authenticator import VirtualAuthenticatorOptions
from headless_chrome.common.virtual_authenticator import (
...
def import_cdp():
    global cdp
    if not cdp:
        cdp = import_module("headless_chrome.common.bidi.cdp")
...
def get_remote_connection(capabilities, command_executor, keep_alive, ignore_local_proxy=False):
    from headless_chrome.chromium.remote_connection import ChromiumRemoteConnection
