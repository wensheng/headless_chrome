...
from headless_firefox.common.by import By
from headless_firefox.common.options import BaseOptions
from headless_firefox.common.print_page_options import PrintOptions
from headless_firefox.common.timeouts import Timeouts
from headless_firefox.common.virtual_authenticator import Credential
from headless_firefox.common.virtual_authenticator import VirtualAuthenticatorOptions
from headless_firefox.common.virtual_authenticator import (
...
def import_cdp():
    global cdp
    if not cdp:
        cdp = import_module("headless_firefox.common.bidi.cdp")
...
def get_remote_connection(capabilities, command_executor, keep_alive, ignore_local_proxy=False):
    from headless_firefox.chromium.remote_connection import ChromiumRemoteConnection
